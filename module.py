...
class CherryPyConfig(object):
    ...
    def _configure(self):
        ...
        #导出日志
        appserver_error_log = os.path.join(os.environ['HOME'], 'dblogs','appserver_error.log')
        appserver_access_log = os.path.join(os.environ['HOME'], 'dblogs','appserver_access.log')
